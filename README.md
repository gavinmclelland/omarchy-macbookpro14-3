...
| Speakers + mic | works; layout 57 host | `pipewire/speaker-tuning/` [#14](https://github.com/gavinmclelland/omarchy-macbookpro14-3/issues/14) — test with Still D.R.E.; 80 Hz–16 kHz, not 40 Hz 808 |
