...
- Stereo, Apple order: HPF 80 Hz → Mozart → Loudness 300 Hz +4 / 6.5 kHz +2 → PEQ (280 Hz −20 XML; 1550 Hz +8; −3 dB @ 1050 Hz; **+3 dB @ 100 Hz** for YG-style bass tones) → dual-band → limiter
